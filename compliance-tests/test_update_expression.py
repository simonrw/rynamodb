...
def test_update_expression_set_merge(test_table_s):
    ...
    test_table_s.update_item(
        ...
        ExpressionAttributeValues={":val": "hey"},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "a": "hey",
...
def test_update_expression_set_copy(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET x = :val1, y = x",
            ExpressionAttributeValues={":val1": 4},
        )
...
def test_update_expression_set_nested_copy(test_table_s):
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET #nn = :seven - #n",
        ExpressionAttributeNames={"#nn": "nn", "#n": "n"},
        ExpressionAttributeValues={":seven": 7},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "n": 2,
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET #nnn = :nnn",
        ExpressionAttributeNames={"#nnn": "nnn"},
        ExpressionAttributeValues={":nnn": [2, 4]},
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET #nnnn = list_append(:val1, #nnn)",
        ExpressionAttributeNames={"#nnnn": "nnnn", "#nnn": "nnn"},
        ExpressionAttributeValues={":val1": [1, 3]},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "n": 2,
...
def test_update_expression_set_key(test_table_sn):
    ...
    test_table_sn.update_item(
        Key={"p": p, "c": 7},
        UpdateExpression="SET #nn = #c + #c",
        ExpressionAttributeNames={"#nn": "nn", "#c": "c"},
    )
    assert test_table_sn.get_item(Key={"p": p, "c": 7}, ConsistentRead=True)[
        "Item"
    ] == {"p": p, "c": 7, "n": p, "nn": 14}
...
def test_update_expression_name_token(test_table_s):
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET alnum = :val1",
        ExpressionAttributeValues={":val1": 1},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["alnum"] == 1
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET Alpha_Numeric_123 = :val1",
        ExpressionAttributeValues={":val1": 2},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"][
            "Alpha_Numeric_123"
        ]
        == 2
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET A123_ = :val1",
        ExpressionAttributeValues={":val1": 3},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["A123_"] == 3
    )
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET _123 = :val1",
            ExpressionAttributeValues={":val1": 3},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET _abc = :val1",
            ExpressionAttributeValues={":val1": 3},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET 123a = :val1",
            ExpressionAttributeValues={":val1": 3},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET 123 = :val1",
            ExpressionAttributeValues={":val1": 3},
        )
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET hi-there = :val1",
            ExpressionAttributeValues={":val1": 3},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression='SET "hithere" = :val1',
            ExpressionAttributeValues={":val1": 3},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
    ...
    test_table_s.update_item(
        ...
        UpdateExpression="SET #Alpha_Numeric_123 = :val1",
        ExpressionAttributeValues={":val1": 4},
        ExpressionAttributeNames={"#Alpha_Numeric_123": silly_name},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"][silly_name]
        == 4
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET #123a = :val1",
        ExpressionAttributeValues={":val1": 5},
        ExpressionAttributeNames={"#123a": silly_name},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"][silly_name]
        == 5
    ...
    test_table_s.update_item(
        ...
        ExpressionAttributeNames={"#123": silly_name},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"][silly_name]
        == 6
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET #_ = :val1",
        ExpressionAttributeValues={":val1": 7},
        ExpressionAttributeNames={"#_": silly_name},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"][silly_name]
        == 7
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            ...
            UpdateExpression="SET #hi-there = :val1",
            ExpressionAttributeValues={":val1": 7},
            ExpressionAttributeNames={"#hi-there": silly_name},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET #!hi = :val1",
            ExpressionAttributeValues={":val1": 7},
            ExpressionAttributeNames={"#!hi": silly_name},
        )
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET # = :val1",
            ExpressionAttributeValues={":val1": 7},
            ExpressionAttributeNames={"#": silly_name},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET # = :val1",
            ExpressionAttributeValues={":val1": 7},
            ExpressionAttributeNames={"#a": silly_name},
        )
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a = :Alpha_Numeric_123",
        ExpressionAttributeValues={":Alpha_Numeric_123": 8},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == 8
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a = :123a",
        ExpressionAttributeValues={":123a": 9},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == 9
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a = :123",
        ExpressionAttributeValues={":123": 10},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == 10
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a = :_",
        ExpressionAttributeValues={":_": 11},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == 11
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :hi!there",
            ExpressionAttributeValues={":hi!there": 12},
        )
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            ...
            ExpressionAttributeValues={":": 7},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :",
            ExpressionAttributeValues={":a": 7},
        )
...
def test_update_expression_multi(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :val1 SET b = :val2",
            ExpressionAttributeValues={":val1": 1, ":val2": 2},
        )
    # We can have a REMOVE and a SET clause (note no comma between clauses):
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="REMOVE a SET b = :val2",
        ExpressionAttributeValues={":val2": 3},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "b": 3,
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET c = :val2 REMOVE b",
        ExpressionAttributeValues={":val2": 3},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :val1 REMOVE a SET b = :val2",
            ExpressionAttributeValues={":val1": 1, ":val2": 2},
        )
...
def test_update_expression_multi_overlap(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="REMOVE a SET a = :v",
            ExpressionAttributeValues={":v": "hi"},
        )
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :v REMOVE a",
            ExpressionAttributeValues={":v": "yo"},
        )
    # It's also not allowed to set a twice in the same clause
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a = :v1, a = :v2",
            ExpressionAttributeValues={":v1": "yo", ":v2": "he"},
        )
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(
            ...
            ExpressionAttributeValues={":v1": "yo", ":v2": "he"},
            ExpressionAttributeNames={"#a1": "a", "#a2": "a"},
        )
...
def test_update_expression_multi_nested(test_table_s):
    ...
    test_table_s.put_item(
        Item={"p": p, "a": {"x": 3, "y": 4, "c": {"y": 3}}, "b": {"x": 1, "y": 2}}
    )
    test_table_s.update_item(
        Key={"p": p},
...
def test_update_expression_set_missing_value(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException"):
        test_table_s.update_item(Key={"p": p}, UpdateExpression="SET b = :val1")
...
def test_update_expression_cannot_modify_key(test_table):
    ...
    with pytest.raises(ClientError, match="ValidationException.*key"):
        test_table.update_item(
            Key={"p": p, "c": c},
            UpdateExpression="ADD p :val1",
            ExpressionAttributeValues={":val1": 4},
        )
    with pytest.raises(ClientError, match="ValidationException.*key"):
        test_table.update_item(
            Key={"p": p, "c": c},
            UpdateExpression="ADD c :val1",
            ExpressionAttributeValues={":val1": 4},
        )
    with pytest.raises(ClientError, match="ValidationException.*key"):
        test_table.update_item(
    ...
    assert test_table.get_item(Key={"p": p, "c": c}, ConsistentRead=True)["Item"] == {
        "p": p,
        "c": c,
        "a": 4,
    }
...
def test_update_expression_plus_rmw(test_table_s):
    ...
    test_table_s.update_item(Key={"p": p}, UpdateExpression="SET a = b + a")
...
def test_update_expression_list_append(test_table_s):
    ...
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["b"] == [
        "dog",
        "hi",
        2,
        4,
    ...
    test_table_s.update_item(Key={"p": p}, UpdateExpression="SET c = list_append(a, b)")
...
# nesting.
@pytest.mark.xfail(
    reason="for unknown reason, DynamoDB does not allow nesting list_append"
)
...
def test_update_expression_unknown_function(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException.*f"):
        test_table_s.update_item(Key={"p": p}, UpdateExpression="SET a = f(b,c,d)")
    with pytest.raises(ClientError, match="ValidationException.*f123_hi"):
        test_table_s.update_item(
            Key={"p": p}, UpdateExpression="SET a = f123_hi(b,c,d)"
        )
    ...
    with pytest.raises(ClientError, match="ValidationException.*yntax error"):
        test_table_s.update_item(Key={"p": p}, UpdateExpression="SET a = _f(b,c,d)")
...
def test_update_expression_add_sets(test_table_s):
    ...
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == set(
        ["dog", "cat", "mouse", "pig"]
    )
    ...
    test_table_s.put_item(
        Item={"p": p, "a": set(["beaver", "lynx", "coati"]), "b": "hi"}
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="ADD a :val1",
...
def test_update_expression_add_sets_new(test_table_s):
    ...
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["b"] == set(
        ["dog"]
    )
    # Test that "ADD" can create an entirely new item:
    p = random_string()
...
def test_update_expression_nested_attribute_index_reference(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException.*yntax"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a[:xyz] = :val1",
...
def test_update_expression_nested_deep(test_table_s):
    p = random_string()
    test_table_s.put_item(
        Item={"p": p, "a": {"b": 3, "c": ["hi", {"x": {"y": [3, 5, 7]}}]}}
    )
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a.c[1].#name.y[1] = :val1",
        ExpressionAttributeValues={":val1": 9},
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a.z = a.c[1].#name.y[1]",
        ExpressionAttributeNames={"#name": "x"},
    )
    assert (
        test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"]["z"] == 9
    )
...
def test_update_expression_nested_remove(test_table_s):
    p = random_string()
    test_table_s.put_item(
        Item={"p": p, "a": {"b": 3, "c": ["hi", {"x": {"y": [3, 5, 7]}, "q": 2}]}}
    )
    test_table_s.update_item(
        Key={"p": p}, UpdateExpression="REMOVE a.c[1].x.y[1], a.c[1].q"
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == {
        "b": 3,
        "c": ["hi", {"x": {"y": [3, 7]}}],
...
def test_update_expression_nested_remove_list_item_original_number(test_table_s):
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="REMOVE a[1] SET a[3] = :val",
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a[3] = :val REMOVE a[1]",
        ExpressionAttributeValues={":val": 17},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"]["a"] == [
        2,
...
def test_nested_attribute_update_array_out_of_bounds(test_table_s):
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a[7] = :val1",
        ExpressionAttributeValues={":val1": "hello"},
    )
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "a": ["one", "two", "three", "hello"],
    }
    ...
    test_table_s.update_item(
        Key={"p": p},
        UpdateExpression="SET a[84] = :val1, a[37] = :val2, a[17] = :val3, a[50] = :val4",
        ExpressionAttributeValues={
            ":val1": "a1",
            ":val2": "a2",
            ":val3": "a3",
    ...
    assert test_table_s.get_item(Key={"p": p}, ConsistentRead=True)["Item"] == {
        "p": p,
        "a": ["one", "two", "three", "hello", "a3", "a2", "a4", "a1"],
    }
...
def test_nested_attribute_update_bad_path_dot(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException.*path"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET b.c = :val1",
            ExpressionAttributeValues={":val1": 7},
        )
    with pytest.raises(ClientError, match="ValidationException.*path"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET c.c = :val1",
            ExpressionAttributeValues={":val1": 7},
        )
...
@pytest.mark.xfail(
    reason="for unknown reason, DynamoDB allows REMOVE x.y when item doesn't exist"
)
...
def test_nested_attribute_update_bad_path_array(test_table_s):
    ...
    with pytest.raises(ClientError, match="ValidationException.*path"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET a[0] = :val1",
            ExpressionAttributeValues={":val1": 7},
        )
    with pytest.raises(ClientError, match="ValidationException.*path"):
        test_table_s.update_item(
            Key={"p": p},
            UpdateExpression="SET b[0] = :val1",
            ExpressionAttributeValues={":val1": 7},
        )
    # Same errors for "remove" operation.
    with pytest.raises(ClientError, match="ValidationException.*path"):
...
def test_update_expression_when_rmw(test_table_s_forbid_rmw):
    ...
    # it *does* need RMW:
    with pytest.raises(
        ClientError, match="ValidationException.*write isolation policy"
    ):
        table.update_item(
            Key={"p": p},
    ...
    with pytest.raises(
        ...
        table.update_item(Key={"p": p}, UpdateExpression="SET b = a")
